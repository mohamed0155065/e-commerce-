      ...
      <div className="border-t border-stone-200">
        <div className="page-shell flex flex-col gap-6 py-10 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex gap-12">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-stone-400">Shop</p>
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-stone-400">Help</p>
              <ul className="mt-3 space-y-2 text-sm text-stone-600">
