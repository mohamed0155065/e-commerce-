 ...
 * - Displays a shipping form and order summary
 * - Validates user input using zod and react-hook-form
 * - Inserts order into Supabase
 * - Clears cart and redirects to success page on completion
 */
export default function CheckoutPage() {
     ...
     * @param formData - validated checkout form input
     */
    ...
    if (items.length === 0) return (
        <div className="h-screen flex flex-col items-center justify-center bg-slate-50 text-center px-4">
            <p className="text-xl font-bold text-slate-400 mb-6 tracking-tight">
                    ...
                    <div className="lg:col-span-7 bg-white rounded-[2.5rem] p-8 lg:p-12 shadow-sm border border-slate-100">
                        <div className="mb-10">
                            <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase">
                                Shipping <span className="text-indigo-600">Details</span>
                            </h1>
